...
```ruby
= flash_message :success, t('flash.success.default')
= flash_message :warning, t('flash.warning.default')
= flash_message :danger, t('flash.danger.default')
= flash_message :info, t('flash.info.default')
```
