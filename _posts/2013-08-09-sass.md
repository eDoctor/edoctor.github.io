...
- 对于像`.active`、`.disabled`、`.selected`等比较通用的、表示状态的名称，需限定作用域。
...
<button type="button" class="btn" style="font-size: 18px">font-size: 18px</button>
<button type="button" class="btn" style="font-size: 22px">font-size: 22px</button>
